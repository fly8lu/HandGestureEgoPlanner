// Generated by gencpp from file uav_server/PositionReference.msg
// DO NOT EDIT!


#ifndef UAV_SERVER_MESSAGE_POSITIONREFERENCE_H
#define UAV_SERVER_MESSAGE_POSITIONREFERENCE_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::uav_server::PositionReference_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::uav_server::PositionReference_<ContainerAllocator> const> ConstPtr;

}; // struct PositionReference_

typedef ::uav_server::PositionReference_<std::allocator<void> > PositionReference;

typedef boost::shared_ptr< ::uav_server::PositionReference > PositionReferencePtr;
typedef boost::shared_ptr< ::uav_server::PositionReference const> PositionReferenceConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::uav_server::PositionReference_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::uav_server::PositionReference_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::uav_server::PositionReference_<ContainerAllocator1> & lhs, const ::uav_server::PositionReference_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::uav_server::PositionReference_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::uav_server::PositionReference_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::uav_server::PositionReference_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::uav_server::PositionReference_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uav_server::PositionReference_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::uav_server::PositionReference_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::uav_server::PositionReference_<ContainerAllocator> >
{
  ...
  static const char* value(const ::uav_server::PositionReference_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9ad4ca13cd19c5a6ULL;
  static const uint64_t static_value2 = 0x704afba61c385596ULL;
};

template<class ContainerAllocator>
struct DataType< ::uav_server::PositionReference_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::uav_server::PositionReference_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::uav_server::PositionReference_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::uav_server::PositionReference_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::uav_server::PositionReference_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // UAV_SERVER_MESSAGE_POSITIONREFERENCE_H
