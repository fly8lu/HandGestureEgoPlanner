...
(cl:defmethod cl:initialize-instance :after ((m <PositionReference>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PositionReference)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uav_server-msg:<PositionReference> is deprecated: use uav_server-msg:PositionReference instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PositionReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_server-msg:header-val is deprecated.  Use uav_server-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'Move_mode-val :lambda-list '(m))
(cl:defmethod Move_mode-val ((m <PositionReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_server-msg:Move_mode-val is deprecated.  Use uav_server-msg:Move_mode instead.")
  (Move_mode m))

(cl:ensure-generic-function 'Move_frame-val :lambda-list '(m))
(cl:defmethod Move_frame-val ((m <PositionReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_server-msg:Move_frame-val is deprecated.  Use uav_server-msg:Move_frame instead.")
  (Move_frame m))

(cl:ensure-generic-function 'time_from_start-val :lambda-list '(m))
(cl:defmethod time_from_start-val ((m <PositionReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_server-msg:time_from_start-val is deprecated.  Use uav_server-msg:time_from_start instead.")
  (time_from_start m))

(cl:ensure-generic-function 'position_ref-val :lambda-list '(m))
(cl:defmethod position_ref-val ((m <PositionReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_server-msg:position_ref-val is deprecated.  Use uav_server-msg:position_ref instead.")
  (position_ref m))

(cl:ensure-generic-function 'velocity_ref-val :lambda-list '(m))
(cl:defmethod velocity_ref-val ((m <PositionReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_server-msg:velocity_ref-val is deprecated.  Use uav_server-msg:velocity_ref instead.")
  (velocity_ref m))

(cl:ensure-generic-function 'acceleration_ref-val :lambda-list '(m))
(cl:defmethod acceleration_ref-val ((m <PositionReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_server-msg:acceleration_ref-val is deprecated.  Use uav_server-msg:acceleration_ref instead.")
  (acceleration_ref m))

(cl:ensure-generic-function 'Yaw_Rate_Mode-val :lambda-list '(m))
(cl:defmethod Yaw_Rate_Mode-val ((m <PositionReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_server-msg:Yaw_Rate_Mode-val is deprecated.  Use uav_server-msg:Yaw_Rate_Mode instead.")
  (Yaw_Rate_Mode m))

(cl:ensure-generic-function 'yaw_ref-val :lambda-list '(m))
(cl:defmethod yaw_ref-val ((m <PositionReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_server-msg:yaw_ref-val is deprecated.  Use uav_server-msg:yaw_ref instead.")
  (yaw_ref m))

(cl:ensure-generic-function 'yaw_rate_ref-val :lambda-list '(m))
(cl:defmethod yaw_rate_ref-val ((m <PositionReference>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_server-msg:yaw_rate_ref-val is deprecated.  Use uav_server-msg:yaw_rate_ref instead.")
  (yaw_rate_ref m))
