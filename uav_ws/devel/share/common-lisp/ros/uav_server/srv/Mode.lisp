...
(cl:defmethod cl:initialize-instance :after ((m <Mode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uav_server-srv:<Mode-request> is deprecated: use uav_server-srv:Mode-request instead.")))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <Mode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_server-srv:cmd-val is deprecated.  Use uav_server-srv:cmd instead.")
  (cmd m))
...
(cl:defmethod cl:initialize-instance :after ((m <Mode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uav_server-srv:<Mode-response> is deprecated: use uav_server-srv:Mode-response instead.")))
