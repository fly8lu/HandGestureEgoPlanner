...
class UavGestureRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type UavGestureRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type UavGestureRequest
    let len;
    let data = new UavGestureRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new UavGestureRequest(null);
...
class UavGestureResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type UavGestureResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type UavGestureResponse
    let len;
    let data = new UavGestureResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new UavGestureResponse(null);
...
module.exports = {
  Request: UavGestureRequest,
  Response: UavGestureResponse,
  md5sum() { return 'cf0091775db056556bcbf0c6e550c71f'; },
  datatype() { return 'uav_server/UavGesture'; }
};
